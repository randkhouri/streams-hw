...
public class Homework2 {
    ...
    public Map<ZoneId, Long> streamPipeline10() {
        ...
        var TZ =  countries.stream()
                           .collect(Collectors.groupingBy(Country::getTimezones, Collectors.counting()));
    ...
    public Map<Region, Long> streamPipeline11() {
        var countries = new CountryRepository().getAll();
       var Code =  countries.stream()
               .filter(map -> map.getName().contains(map.getCode()))
    ...
    public Map<Region, List<String>> streamPipeline14() {
       ...
       var Capitals =  countries.stream()
                                .filter(map -> map.getCapital().contains(map.getName()))
